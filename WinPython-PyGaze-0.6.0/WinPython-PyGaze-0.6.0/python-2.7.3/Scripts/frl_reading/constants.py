...
# ]
IMAGES = [os.path.join(RESDIR, 'testImages/020_C2_DV.jpg'),
			os.path.join(RESDIR, 'testImages/025_C2_DV.jpg'),
		  	os.path.join(RESDIR, 'testImages/068_C2_DV.jpg'),
		 	os.path.join(RESDIR, 'testImages/069_C2_DV.jpg'),
		  	os.path.join(RESDIR, 'testImages/074_C2_DV.jpg'),
		  	os.path.join(RESDIR, 'testImages/075_DV_C2.jpg'),
			os.path.join(RESDIR, 'testImages/081_C2_DV.jpg'),
			os.path.join(RESDIR, 'testImages/085_C2_DV.jpg'),
			os.path.join(RESDIR, 'testImages/092_C2_DV.jpg'),
			os.path.join(RESDIR, 'testImages/102_C2_DV.jpg'),
]
FOILIMAGES = [os.path.join(RESDIR, 'testImages/020_C2.jpg'),
			os.path.join(RESDIR, 'testImages/025_C2_DV.jpg'),
		  	os.path.join(RESDIR, 'testImages/068_C2_DV.jpg'),
		 	os.path.join(RESDIR, 'testImages/069_C2_DV.jpg'),
		  	os.path.join(RESDIR, 'testImages/074_C2_DV.jpg'),
