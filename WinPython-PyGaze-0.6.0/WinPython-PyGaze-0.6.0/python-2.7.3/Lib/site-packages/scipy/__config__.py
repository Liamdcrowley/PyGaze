...
amd_info={'libraries': ['amd'], 'library_dirs': ['D:\\Dev\\Compile\\inclib-vc9-x32'], 'swig_opts': ['-ID:\\Dev\\Compile\\inclib-vc9-x32'], 'define_macros': [('SCIPY_AMD_H', None)], 'include_dirs': ['D:\\Dev\\Compile\\inclib-vc9-x32']}
...
umfpack_info={'libraries': ['umfpack', 'amd'], 'library_dirs': ['D:\\Dev\\Compile\\inclib-vc9-x32'], 'swig_opts': ['-ID:\\Dev\\Compile\\inclib-vc9-x32\\umfpack', '-ID:\\Dev\\Compile\\inclib-vc9-x32'], 'define_macros': [('SCIPY_UMFPACK_H', None), ('SCIPY_AMD_H', None)], 'include_dirs': ['D:\\Dev\\Compile\\inclib-vc9-x32\\umfpack', 'D:\\Dev\\Compile\\inclib-vc9-x32']}
