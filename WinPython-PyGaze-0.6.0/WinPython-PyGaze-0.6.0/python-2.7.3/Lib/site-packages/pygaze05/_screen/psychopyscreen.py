...
class PsychoPyScreen(BaseScreen):
	...
	def draw_circle(self, colour=None, pos=None, r=50, pw=1, fill=False):
		...
		if fill:
			self.screen.append(Circle(pygaze.expdisplay, radius=r, edges=128, pos=pos, lineWidth=pw, lineColor=colour, lineColorSpace='rgb', fillColor=colour, fillColorSpace='rgb'))
		else:
			self.screen.append(Circle(pygaze.expdisplay, radius=r-pw, edges=128, pos=pos, lineWidth=pw, lineColor=colour, lineColorSpace='rgb'))
