...
_pkg_config = {
    ...
    'qt_data_dir':       'X:\\Qt484-vc9-x32',
    'qt_dir':            'X:\\Qt484-vc9-x32',
    'qt_edition':        'free',
    'qt_framework':      0,
    'qt_inc_dir':        'X:\\Qt484-vc9-x32\\include',
    'qt_lib_dir':        'X:\\Qt484-vc9-x32\\lib',
    'qt_threaded':       1,
    'qt_version':        0x040804,
    'qt_winconfig':      'shared'
}
...
_default_macros = {
    ...
    'INCDIR':                   '',
    'INCDIR_OPENGL':            '',
    'INCDIR_QT':                'X:\\Qt484-vc9-x32\\include',
    'INCDIR_X11':               '',
    ...
    'MKDIR':                    'mkdir',
    'MOC':                      'X:\\Qt484-vc9-x32\\bin\\\\moc.exe',
    'RANLIB':                   '',
    'RPATH':                    '',
    'STRIP':                    ''
}
