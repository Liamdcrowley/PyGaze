...
class MarkerOutput(Output):
    ...
    def __init__(self, interface, default_code=None, default_duration=None):
        ...
        Keyword arguments:
        interface        -- the interface to use (expyriment.io.SerialPort or
                            expyriment.io.ParallelPort object)
        default_code     -- a default code (int) (optional)
        default_duration -- the default duration (in ms) for sending 0 after a
                            code (int) (optional)
    ...
    def send(self, code=None, duration=None):
        ...
        Keyword arguments:
        code      -- a specific code (int) (optional)
        durartion -- the duration (in ms) for sending a 0 after a code (int)
                     (optional)
