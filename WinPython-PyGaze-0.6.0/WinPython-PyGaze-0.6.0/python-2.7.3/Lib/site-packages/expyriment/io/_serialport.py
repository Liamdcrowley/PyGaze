...
class SerialPort(Input, Output):
    ...
    def __init__(self, port, baudrate=None, bytesize=None, parity=None,
        ...
        Keyword arguments:
        port           -- the port to use (int or str)
        baudrate       -- the baudrate (int) (optional)
        bytesize       -- the bytesize (int) (optional)
        parity         -- the  parity:'E'=even, 'O'=odd, 'N'=none (str)
                          (optional)
        stopbits       -- the number of stopbits (int) (optional)
        timeout        -- the timeout for read(): -1=block (int) (optional)
        xonxoff        -- (int) (optional)
        rtscts         -- (int) (optional)
        dsrdtr         -- (int) (optional)
        input_history  -- True if an input_history should be used (bool)
                          (optional)
        os_buffer_size -- the size of the receive input_history provided by the
                          operating system in bytes (int) (optional)
        _clock          -- an experimental _clock (expyriment.Clock object)
                            (optional)
...
The Python package 'pySerial' is not installed."""
    ...
    def clear(self, skip_input_history=False):
        ...
        Keyword arguments:
        skip_input_history -- if True available data will not be copied to the
                              input_history. (default = False) (optional).
    ...
    def read_input(self):
        ...
        The result will be returned as list.
    ...
    def poll(self):
        ...
        The result (one byte only) will be returned.
    ...
    def read_line(self, duration=None):
        ...
        NOTE: The function is waiting for input. Use the duration parameter
        to avoid too long program blocking.

        Keyword arguments:
        duration -- try to read for given amount of time (default=None)
