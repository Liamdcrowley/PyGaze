...
class TextScreen(Visual):
    ...
    def __init__(self, heading, text, position=None, heading_font=None,
        ...
        Keyword arguments:
        heading            -- the heading of the text screen (str)
        text               -- the text of the text screen (str)
        position           -- the position of the stimulus (int,int)
                              (optional)
        heading_font       -- the heading font to use (str) (optional)
        heading_size       -- the heading font size (int) (optional)
        heading_bold       -- the heading should be bold (bool) (optional)
        heading_italic     -- the heading should be italic (bool)
                              (optional)
        heading_underline  -- the heading should get an underline (bool)
                              (optional)
        heading_colour     -- the heding colour (int,int,int) (optional)
        text_font          -- the text font to use (str) (optional)
        text_size          -- the text font size (int) (optional)
        text_bold          -- the text should be bold (bool) (optional)
        text_italic        -- the text should be italic (bool) (optional)
        text_underline     -- the text should get an underline (bool)
                              (optional)
        text_colour        -- the text colour (int,int,int) (optional)
        text_justification -- 0(left), 1(center), 2(right) (int) (optional)
        background_colour  -- the background_colour (int,int,int) (optional)
        size               -- the size of the text screen (int,int) (optional)
