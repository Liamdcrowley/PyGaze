...
class Ellipse(Visual):
    ...
    def __init__(self, size, colour=None, line_width=None, position=None):
        ...
        Keyword arguments:
        size       -- the size of the ellipse (major and minor axis) (int,int)
        colour     -- the colour of the ellipse (int,int,int) (optional)
        line_width -- the line width in pixels; 0 will result in a filled
                      ellipse (as does a value < 0 or >= min(size)) (optional)
    ...
    def _create_surface(self):
        ...
        if self._line_width == 0:
            ...
            # Invert colours and use it as colorkey for a temporal surface,
            # fill the surface and draw a smaller ellipse with colorkey colour
