...
class Shape(Visual):
    ...
    def __init__(self, position=None, colour=None, line_width=None,
        ...
        colour        -- the colour of the shape (int,int,int) (optional)
        line_width    -- the line width in pixels; 0 will result in a filled
                         shape, as does a value < 0 or >= min(size) (optional)
    ...
    @property
    def xy_points(self):
        """Return polygon as list of XYPoints of the shape. The
        representation does not take into account the position. Use
    ...
    def add_vertices(self, vertex_list):
        ...
        Keyword arguments:
        vertex_list -- list of vertices (int, int)
    ...
    def convert_expyriment_xy_to_surface_xy(self, point_xy):
        ...
        Keyword arguments:
        point_xy -- Expyriment screen coordinates (tuple)
    ...
    def overlapping_with_shape(self, other):
        ...
        Keyword arguments:
        other -- the other shape (stimuli.Shape object)
    ...
    def native_scale(self, factors, scale_line_width=False):
        ...
        Keyword arguments:
        factors             -- the x and y factors to scale ([int, int] or int)
        scale_line_width    -- if True, line_width will be scaled proportionally
                               to the change in surface size (boolean, optional,
                               default=False)
    ...
    def blur(self, level):
        ...
        'level'.
        Depending on the blur level and the size of your stimuulus, this method
        may take some time!
