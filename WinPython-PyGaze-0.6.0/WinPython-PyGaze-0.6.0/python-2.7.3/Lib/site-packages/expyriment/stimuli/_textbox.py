...
class TextBox(Visual):
    ...
    def __init__(self, text, size, position=None, text_font=None,
        ...
        size               -- the size of the text box (int,int)
        position           -- the position of the stimulus (int,int)
                              (optional)
        text_font          -- the text font to use as a name or as a path to a
                              font file (str) (optional)
        text_size          -- the size of the text (int) (optional)
        text_bold          -- the font should be bold (bool) (optional)
        text_italic        -- the font should be italic (bool) (optional)
        text_underline     -- the font should get an underline (bool)
                              (optional)
        text_justification -- 0 (left), 1 (center), 2 (right) (int) (optional)
        text_colour        -- the text colour (int,int,int) (optional)
        ...
        try:
            ...
            actual_font = pygame.font.match_font(self._text_font)
            if actual_font is None:
                self._text_font = pygame.font.get_default_font().split(".")[0]
            else:
                fullpath = pygame.font.match_font(self._text_font)
                filename = fullpath.split(os.path.sep)[-1]
                self._text_font = filename.split(".")[0]
    ...
    def _create_surface(self):
        ...
        try:
            ...
            _font = pygame.font.SysFont(self._text_font, self._text_size)
        _font = pygame.font.SysFont(self.text_font, self.text_size)
    ...
    def render_textrect(self, string, font, rect, text_colour,
        ...
        string            -- the text you wish to render. \n begins a new line
                             (str)
        font              -- a Font object (pygame.Font object)
        rect              -- a rectstyle giving the size of requested surface
                             (pygame.Rect object)
        text_colour       -- the text colour (int,int,int)
        background_colour -- the background colour (int,int,int)
        justification     -- 0 (left), 1 (center), 2 (right) (int)
                             (default = 0)
    ...
    def format_block(self, block):
        ...
        Keyword arguments:
        block - the block of text to be formatted (str)
