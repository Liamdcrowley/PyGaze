...
class Tone(Audio):
    ...
    def __init__(self, duration, frequency=None, samplerate=None,
        ...
        Keyword arguments:
        duration   -- the duration of the file in ms (int)
        frequency  -- the frequency of the sine tone (int) (optional)
        samplerate -- the samplerate of the sine tone (int) (optional)
        bitdepth   -- the bitdeth of the sine tone (int) (optional)
        amplitude  -- the amplitude of the sine tone (int) (optional)
    ...
    def save(self, filename):
        ...
        Keyword arguments:
        filename -- the filename the sine tone should be saved to (str)
