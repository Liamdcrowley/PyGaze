...
class StimulusCloud(Visual):
    ...
    def __init__(self, size=None, position=None, background_colour=None):
        ...
        Keyword arguments:
        size              -- the size of the cloud (int,int) (optional)
        position          -- the position of the cloud (int,int) (optional)
    ...
    def make(self, stimuli, min_distance=None):
        ...
        Keyword arguments:
        stimuli     -- a list of stimuli to put in the cloud (list)
        min_distance-- the minimal allowed distance between stimuli (int)
                       (optional)
