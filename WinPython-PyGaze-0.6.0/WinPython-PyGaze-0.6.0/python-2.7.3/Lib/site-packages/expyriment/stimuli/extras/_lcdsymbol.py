...
class LcdSymbol(Visual):
    ...
    def __init__(self, shape, position=None, size=None, colour=None,
        ...
        Keyword arguments:
        shape             -- the shape to show (list) (see also _shapes)
        position          -- the position to show the symbol (int,int)
                             (optional)
        size              -- the size of the LCD symbol (int,int) (optional)
        colour            -- the LCD symbol colour (int,int,int) (optional)
        inactive_colour   -- the colour of inactive lines (int,int,int)
                             (optional)
        background_colour -- the background colour (int,int,int) (optional)
        line_width        -- the width of the lines (int) (optional)
        gap               -- the gab between lines (int) (optional)
        simple_lines      -- use simple lines (bool) (optional)
    ...
    def _line_to_polygon(self, start, end, horizontal):
        ...
        Keyword arguments:
        start      -- the start point (int)
        end        -- the end point (int)
        horizontal -- True or False (bool)
