...
class DotCloud(Visual):
    ...
    def __init__(self, radius=None, position=None, background_colour=None,
        ...
        Keyword arguments:
        radius            -- the radius of the cloud (int) (optional)
        position          -- the position of the stimulus (int,int) (optional)
        background_colour -- the colour of the background (int,int,int)
                             (optional)
        dot_colour        -- the colour of the dots (int,int,int) (optional)
    ...
    def _is_overlapping_with_point(self, dot, gap):
        ...
        Keyword arguments:
        dot -- the other dot (expyriment.stimuli.Dot object)
        gap -- a constant added to the distance (int)
    ...
    def make(self, n_dots, dot_radius, gap=0):
        ...
        Keyword arguments:
        n_dots     -- the number of dots to put into the cloud (int)
        dot_radius -- the radius of the dots (int)
        gap        -- the gap between dots (int) (default = 0)
    ...
    def shuffel_dot_sequence(self, from_idx=0, to_idx= -1):
        ...
        Keyword arguments:
        from_idx -- index to start from (int) (default = 0)
        to_idx   -- index to end on (int) (default = -1)
