...
def _search_doc(search_str, doc_dict):
    ...
    Keyword arguments:
    search_str -- the string to search for (str)
    doc_dict   -- the documentation dict to search in (dict)
...
The Python package 'Tkinter' is not installed""")
    ...
    def update_search(_event):
        ...
        Keyword arguments:
        _event -- a dummy argument, necessary for callbacks
    ...
    def member_list(_event, member=None):
        ...
        Keyword arguments:
        _event -- a dummy argument, necessary for callbacks
        member -- the item to show_GUI members of (str) (optional)
...
def show_documentation(docu_type=None):
    ...
    Keyword arguments:
    docu_type -- the documentation type (int) (optional)
    ...
    if docu_type is None:
        ...
        _proc = subprocess.Popen(
            "{0} -m expyriment._api_reference_tool".format(python_executable),
            shell=True,
            stdin=None,
            stdout=None,
            cwd=path)
