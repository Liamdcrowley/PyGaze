...
def _square_of_elements(list_, idx_square):
    ...
    Returns a square array with the elements from the list defined by
...
def is_permutation_type(string):
    """Return true if the string or value is a know permutation type.

    Keyword arguments:
    string -- the permutation type string

    """

    return (string == _misc.constants.P_RANDOM or \
            string == _misc.constants.P_CYCLED_LATIN_SQUARE or \
            string == _misc.constants.P_BALANCED_LATIN_SQUARE)
...
def balanced_latin_square(elements):
    ...
    Keyword arguments:
    elements -- the list of elements or a number (list or int)
