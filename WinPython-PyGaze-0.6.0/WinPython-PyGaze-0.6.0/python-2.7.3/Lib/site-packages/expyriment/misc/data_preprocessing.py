...
def read_datafile(filename, only_header_and_variable_names=False):
    ...
    Returns the data, the variable names, the subject info & the comments:
        ...
        subject_info -- dictionary with subject information (incl.
                        date and between subject factors)
        comments     -- string with remaining comments

    Keyword arguments:
    filename                       -- name (fullpath) of the expyriment data
                                      file (str)
    only_header_and_variable_names -- if True the function reads only the
                                      header and variable names (bool)
                                      (default=False)
...
def write_csv_file(filename, data, varnames=None, delimiter=','):
    ...
    Keyword arguments:
    filename  -- name (fullpath) of the data file (str)
    data      -- 2D array with data (list of list)
    variables -- array of strings representing variable names
                 (list of str) (optional)
    delimiter -- delimiter character (str) (default=",")
...
def write_concatenated_data(data_folder, file_name, output_file=None,
    ...
    Keyword arguments:
    data_folder -- the folder which contains of data of the subjects (str)
    file_name   -- the name of the files (str)
                   Note: All files that start with this name will be
                   considered for the analysis (cf. aggregator.data_files)
    output_file -- the name of data output file (str) (optional)
...
class Aggregator(object):
    ...
    def __init__(self, data_folder, file_name, suffix=_default_suffix):
        ...
        file_name   -- the name of the files (str)
                       Note: All files that start with this name will be
                       considered for the analysis (cf. aggregator.data_files)
        suffix      -- if specified only files that end with this particular
                       suffix will be considered (optional, default=.xpd)
...
The Python package 'numpy' is not installed."""
    ...
    def _find_idx(self, data, column_id, relation, value):
        ...
        column_id -- the id of column to compare
        relation  -- the relation as string.  possible relations:
                         "==", "!=", ">", "<", ">=", "<=", "=>", "<="
        value     -- the value to find or a variable name
    ...
    def get_data(self, filename, recode_variables=True,
        ...
        Returns the data (numpy.array), the variable names, the subject info &
        the comments.
        ...
        Keyword arguments:
        filename              -- name of the Expyriment data file (str)
        recode_variables      -- set to False if defined variable recodings
                                 should not be applied (bool, default=False)
        compute_new_variables -- set to False if new defined variables should
                                 not be computed (bool, default=False)
        exclude_trials        -- set to False if exclusion rules should not be
        ...
        data = _np.array(data, dtype='|S99') # TODO S99, requires tesing
    ...
    def get_variable_data(self, variables):
        ...
        Keyword arguments:
        variables -- the names of the variables to be extracted (list)
    ...
    def add_variables(self, variable_names, data_columns):
        ...
        The amount of variables and added columns must. The added data
        ...
        Keyword arguments:
        variable_names -- the name of the new variable(s) (list of str)
        data_columns   -- the new data columns as numpy array
    ...
    def write_concatenated_data(self, output_file=None, delimiter=','):
        ...
        Keyword arguments:
        output_file -- the name of data output file (str) (optional)
                       If no specified data will the save to
                       {file_name}.csv
        delimiter   -- delimiter character (str) (default=",")
    ...
    def set_independent_variables(self, variables):
        ...
        Keyword arguments:
        variables -- A string or a list of strings that represent the names of
                     one or more data variables (aggregator.variables)
    ...
    def set_dependent_variables(self, dv_syntax):
        ...
        Keyword arguments:
        dv_syntax -- A string or a list of strings that represent the
                     dependent dv_syntax defined by a function and variable,
                     e.g. mean(RT)

        Syntax:
        {function}({variable})
            {function} -- mean, median, sum, std or n_trials
                          Note: n_trials counts the number of trials and does
                          not require a variable as argument
    ...
    def set_exclusions(self, rule_syntax):
        ...
        Keyword arguments:
        rule_syntax -- A string or a list of strings that represent the rules
                       to exclude trials
    ...
    def set_variable_recoding(self, recoding_syntax):
        ...
        Keyword arguments:
        rule_syntax -- A string or a list of strings that represent the
                       variable recoding syntax
    ...
    def set_subject_variables(self, variables):
        ...
        Keyword arguments:
        variables -- A string or a list of strings that represent the subject
                     variables
        """
    ...
    def set_computed_variables(self, compute_syntax):
        ...
        Keyword arguments:
        compute_syntax -- A string or a list of strings that represent the
                          syntax to compute the new variables
    ...
    def aggregate(self, output_file=None, column_subject_id=0):
        ...
        Keyword arguments:
        output_file      -- the name of data output file (str) (optional)
                            If this output_file is defined the function
                            write the results as csv data file
        subject variable -- the data column containing the subject id
                            (int) (odefault=0)
